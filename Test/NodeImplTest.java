...
public class NodeImplTest {
	...
	public void testSetChildAt() {
		NodeImpl n = new NodeImpl(1, 1, 1, 0, 0);
		NodeImpl child = new NodeImpl(1, 2, 1, 1, 0);
	...
	public void testGetState() {
		NodeImpl t = new NodeImpl(1, 0, 0, 0, 0);
		assertEquals("Result", 1, t.getState());

		NodeImpl n = new NodeImpl(-1, 0, 0, 0, 0);
		assertEquals("Result", -1, n.getState());
